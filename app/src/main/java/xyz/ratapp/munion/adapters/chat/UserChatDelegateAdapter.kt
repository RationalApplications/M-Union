 ...
 * @author Simon
 */
class UserChatDelegateAdapter : ViewTypeDelegateAdapter {
    ...
    class TurnsViewHolder(parent: ViewGroup) : RecyclerView.ViewHolder(parent.inflate(R.layout.item_chat_right)) {
