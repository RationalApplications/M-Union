...
import xyz.ratapp.munionagent.ui.activities.chat.ChatActivity;
import xyz.ratapp.munionagent.ui.activities.profile.EditProfileActivity;

import static co.chatsdk.ui.manager.BaseInterfaceAdapter.THREAD_ENTITY_ID;
import static co.chatsdk.ui.manager.BaseInterfaceAdapter.USER_ENTITY_ID;
...
public class PrivateThreadsFragment extends BaseFragment {
    ...
    private void initList() {
        ...
        adapter.onClickObservable().subscribe(new Consumer<Thread>() {
            ...
            public void accept(@NonNull Thread thread) throws Exception {
                ...
                intent.putExtra(THREAD_ENTITY_ID, thread.getEntityID());
    ...
    public void showSettings() {
        ...
        intent.putExtra(USER_ENTITY_ID, NM.currentUser().getEntityID());
        startActivity(intent);
    }
